	    		...
	    		<div class="row">
					...
					<div class="portlet light bg-inverse">
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form id="form" method="post" action="{{ action('User\TaxServiceController@postTaxservice') }}" class="form-horizontal">
							 	{!! csrf_field() !!}
								<div class="form-body">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-8">
													<input name="firstname" value="{{ old('firstname') }}" type="text" class="form-control" placeholder="">
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-4">Last Name</label>
												<div class="col-md-8">
													<input name="lastname" value="{{ old('lastname') }}" type="text" class="form-control" placeholder="">
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-4">Social Insurance Number</label>
												<div class="col-md-8">
													<input name="socialinsurancenumber" value="{{ old('socialinsurancenumber') }}" type="number" class="form-control" placeholder="" min="1">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
													...
													<div class="col-md-8">
														<input id="address" value="{{ old('address') }}" name="address" type="text" class="form-control">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<input value="{{ old('provinceorstate') }}" name="provinceorstate" type="text" class="form-control">
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-4">Postal Code</label>
													<div class="col-md-8">
														<input value="{{ old('postalcode') }}" name="postalcode" type="text" class="form-control">
													</div>
												</div>
										</div>
												...
												<div class="col-md-9">
													<div class="radio-list">
															...
															<label class="radio-inline">
																...
																<input type="radio" name="spouse" value="no" checked /> No
															</label>
													</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label class="control-label col-md-4">Social Insurance Number</label>
													<div class="col-md-8">
														<input value="{{ old('spousesocialinsurancenumber') }}" name="spousesocialinsurancenumber" type="text" class="form-control" min="1">
													</div>
												</div>									
											</div>
										</div>
												...
												<div class="col-md-9">
													<div class="radio-list">
														...
														<label class="radio-inline">
															...
															<input type="radio" name="dependent" value="no" checked /> No
														</label>
													</div>
												</div>
											</div>
