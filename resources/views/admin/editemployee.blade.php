	    	...
	    	<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<a class="btn red btn-lg" href="{{ action('Admin\AdminController@adminindex') }}" >Create a Employee</a>
					</div>
						...
						<div id="responsive" class="modal fade" role="responsive" tabindex="-1" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form action="{{ action('Admin\AdminController@postEditEmployee', ['id' => $employee->id]) }}" method="post">
										{!! csrf_field() !!}
