	...
	<div class="wrapper">
	    ...
	    <div class="container-fluid">
	    	<div class="page-content">
				...
				<div class="row">
					<form id="file" action="{{ action('Admin\AdminController@usersearch') }}" method="get">
						{!! csrf_field() !!}
						<div class="col-md-3">
						...
						<div class="col-md-9">
							<div class="form-group">
								...
								<button class="btn green" type="submit" style="margin-bottom:15px;">Search User</button>
								<a class="btn green" href="{{ action('Admin\AdminController@userindex') }}" style="margin-bottom:15px;">Refresh</a>
							</div>
						</div>
					</form>										
				</div>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-cogs"></i>Users Listing
								</div>
							</div>
